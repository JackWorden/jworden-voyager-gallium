...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    MO(5),          KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       MO(4),          
  ...
  [2] = LAYOUT_voyager(
    MT(MOD_LGUI, KC_ESCAPE),KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_5,                                           KC_6,           KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [3] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, DUAL_FUNC_0,    KC_LEFT_ALT,    KC_LEFT_CTRL,   DUAL_FUNC_1,    KC_PC_COPY,                                     KC_PC_COPY,     KC_LEFT,        KC_UP,          KC_DOWN,        KC_RIGHT,       KC_TRANSPARENT, 
  ...
  [4] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, DUAL_FUNC_2,    DUAL_FUNC_3,    MT(MOD_LCTL, KC_SCLN),MT(MOD_LSFT, KC_DOT),KC_COMMA,                                       KC_TRANSPARENT, DUAL_FUNC_4,    DUAL_FUNC_5,    DUAL_FUNC_6,    DUAL_FUNC_7,    KC_TRANSPARENT, 
  ...
  [5] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, CG_SWAP, CG_NORM, 
